...
async def deep_health_check() -> dict[str, Any]:
    ...
    from phoenix_ml.infrastructure.monitoring.health_check import HealthChecker  # noqa: PLC0415
...
async def batch_predict(
    ...
    from phoenix_ml.application.commands.batch_predict_command import (  # noqa: PLC0415
        BatchPredictCommand,
    )
    from phoenix_ml.application.handlers.batch_predict_handler import (  # noqa: PLC0415
        BatchPredictHandler,
    )
...
async def check_drift(
    ...
    try:
        ...
        from phoenix_ml.infrastructure.bootstrap.lifespan import (  # noqa: PLC0415
            alert_manager,
        )
...
async def register_model(
    ...
    from phoenix_ml.domain.inference.entities.model import Model  # noqa: PLC0415
